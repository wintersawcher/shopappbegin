...
import com.example.shopappn.activity.GioHangActivity;
import com.example.shopappn.inteface.IImageClickListenner;
...
public class GioHangAdapter extends RecyclerView.Adapter<GioHangAdapter.MyViewHolder> {
    ...
    //          holder.item_giohang_gia.setText(gioHang.getSoluong());
    ...
    public class MyViewHolder extends RecyclerView.ViewHolder implements View.OnClickListener{
        ...
        TextView item_giohang_tensp,item_giohang_soluong,item_giohang_giasp2,item_giohang_gia;
        IImageClickListenner listenner;
        public MyViewHolder(@NonNull View itemView) {
            super(itemView);
             item_giohang_tensp = itemView.findViewById(R.id.item_giohang_ten);
